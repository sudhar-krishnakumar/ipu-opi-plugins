...
// Note: Skipping the interfaces that are not available for use.
var interfaces [10]string = [10]string{"enp0s1f0d6", "enp0s1f0d7", "enp0s1f0d8", "enp0s1f0d9", "enp0s1f0d10",
...
func (s *server) CreateBridgePort(_ context.Context, in *pb.CreateBridgePortRequest) (*pb.BridgePort, error) {
	...
	//Note: s.uplinkInterface was PREVIOUSLY linux bridge-> d3 interface on ACC.
